...
using ExpenseManager.Sessions;
using ExpenseManager.Web.Controllers.Results;
using ExpenseManager.Web.Models;
using ExpenseManager.Web.Models.Account;
...
{
    public class AccountController : ExpenseManagerControllerBase
    {
        ...
        private bool IsSelfRegistrationEnabled()
        {
            ...
            return false; // disable it for all users
            //return true;
        }

...
namespace ExpenseManager.Web
{
    ...
    /// </summary>
    public class ExpenseManagerNavigationProvider : NavigationProvider
    {
        ...
        {
            return new LocalizableString(name, ExpenseManagerConsts.LocalizationSourceName);
        }
    }
}
